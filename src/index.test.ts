...
import type { Intent, ThreadMetadata, ThreadObject, UserWorkflow, WorkflowTemplate } from "./types/memory";
...
const userWorkflowMemory: IUserWorkflowMemory = {
	...
	listActiveScheduledWorkflows: jest.fn<Promise<UserWorkflow[]>, []>().mockResolvedValue([]),
};
